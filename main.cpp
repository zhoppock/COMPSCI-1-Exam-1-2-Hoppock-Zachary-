...
int main()
{
  ...
  cout << rope_x << " feet" << endl;
  cout << rope_y << " feet" << endl;
  cout << rope_z << " feet" << endl;
  cout << "Added together = " << sum << " feet" << endl;
  cout << "From the total number of feet convert to " << yardage << " yards" << endl;
  return 0;
}